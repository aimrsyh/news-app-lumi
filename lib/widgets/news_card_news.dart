...
class NewsCardNews extends StatefulWidget {
  NewsCardNews({
    super.key,
  });

  @override
  State<NewsCardNews> createState() => _NewsCardNewsState();
}

class _NewsCardNewsState extends State<NewsCardNews> {
  ...
  void initState() {
    ...
    super.initState();
    BlocProvider.of<NewsBloc>(context).add(GetDataNews());
  }
